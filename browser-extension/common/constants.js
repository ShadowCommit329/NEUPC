...
export const PLATFORMS = {
  ...
  hackerrank: {
    ...
    submissionUrlPattern: /\/challenges\/[^/]+\/submissions\/code\/(\d+)/,
  ...
  beecrowd: {
    ...
    name: 'beecrowd',
    shortName: 'BC',
    baseUrl: 'https://www.beecrowd.com.br',
    hasApi: false,
    hasRating: false,
    hasContests: true,
    urlPatterns: ['*://beecrowd.com.br/*', '*://www.beecrowd.com.br/*'],
    submissionUrlPattern: /\/judge\/[^/]+\/runs\/code\/(\d+)/,
    problemUrlPattern: /\/judge\/[^/]+\/problems\/view\/(\d+)/,
    statusUrlPattern: /\/judge\/[^/]+\/runs/,
    profileUrlTemplate: 'https://www.beecrowd.com.br/judge/en/profile/{handle}',
    color: '#6441a5',
    icon: 'beecrowd',
  },
